...
film1 = Film.new({'title' => 'Star Wars Episode VIII: The Last Jedi', 'price' => 11.5})
film1.save()
film2 = Film.new({'title' => 'Justice League', 'price' => '11.5'})
film2.save()
film3 = Film.new({'title' => 'It\'s a Wonderful Life', 'price' => 11.5})
film3.save()
